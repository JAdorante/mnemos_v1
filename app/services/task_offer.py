...
this does the same for tasks vinceo.ai *hears*. When the extractor mints a task fact
...
Gated so vinceo.ai isn't chatty by TWO independent signals (#10) — an offer must
