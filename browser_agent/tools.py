...
ACTION_TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "vinceo.ai's memory that prompted it. Fill `why`/`source` from the "
            "RELEVANT MEMORIES / conversation context when the task came from "
            "something vinceo.ai heard or a promise the user made — approval should "
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "why": {"type": "string",
                        "description": "why this is being done, grounded in what vinceo.ai "
...
# The vinceo.ai intent/action-router envelope (PRD "Planner LLM Service" output).
