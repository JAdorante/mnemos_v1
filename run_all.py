"""Launch the whole Sparrow system with one command.

    python run_all.py

Starts the whole Sparrow system:
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Launch all of Sparrow at once")
    ...
    print("=" * 62)
    print("  Sparrow — launching everything")
